...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=1120, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None):
        super().__init__()
...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=1120, patch_size=4, in_chans=3, num_classes=29,
